...
|[Модель прогнозирования оттока клиентов](Outflow_bank_customers) | Построение модели прогнозирования оттока банковских клиентов. | *pandas, numpy, scipy, sklearn, matplotlib, seaborn* |
